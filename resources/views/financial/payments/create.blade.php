                    ...
                    <div class="col-md-6">
                        <div class="kt-portlet kt-portlet--height-fluid">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="cart" class="table">
                                                        ...
                                                        {{--<tr id="2">
                                                            ...
                                                            <td class="kt-align-right">$<span id="price2"></span></td>
                                                            <td>
                                                                <div
                                                            ...
                                                            <td class="kt-align-right kt-font-brand kt-font-bold">$<span id="total2"></span></td>
                                                        </tr>--}}
                                                        </tbody>
                                                        <!--end::Tbody-->
                                                    </table>
                            ...
                            <div class="kt-portlet__foot">
                                ...
                                <p style="float:right; font-size:24px;">$<span id="totalprice"></span></p>
