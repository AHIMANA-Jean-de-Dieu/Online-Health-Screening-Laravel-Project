        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($laptemplate) ? 'Edit Lap Template Info' : 'Add Lap Template'}}</h3>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($laptemplate) ? 'Edit Lap Template Info' : 'Add Lap Template'}}
                                </h3>
                            </div>
                        </div>
                        ...
                        <form class="kt-form kt-form--label-right"
                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            You Can Add New Lap Template From This Form.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea name="template" class="summernote" id="kt_summernote_1">{{isset($laptemplate) ? $laptemplate->template : ''}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($laptemplate) ? 'Update' : 'Submit'}}"
...
@section('scripts')
    <script src="{{url('adminpanel')}}/assets/js/demo12/pages/crud/forms/widgets/summernote.js" type="text/javascript"></script>
