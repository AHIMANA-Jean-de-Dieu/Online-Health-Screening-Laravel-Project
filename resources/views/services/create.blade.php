        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($service) ? 'Edit Service Info' : 'Add Service'}}</h3>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($service) ? 'Edit Service Info' : 'Add Service'}}
                                </h3>
                            </div>
                        </div>
                                ...
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            You Can Add New Service From This Form.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                                        ...
                                        @if(isset($departments))
                                            <select class="form-control" name="department" id="department">
                                                ...
                                                @foreach($departments as $department)
                                                    <option
                                                        value="{{$department->id}}" @if(isset($service)) {{$department->id == $service->department_id ? 'selected' : ''}} @endif>{{$department->name}}</option>
                                                @endforeach
                                            </select>
                                        @endif
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                               @if(isset($service)) value="{{$service->name}}"@endif>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="charge" id="charge" step="0.01"
                                               @if(isset($service)) value="{{$service->charge}}"@endif>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="fa fa-heading"></i></span></div>
                                        <input type="number" class="form-control" name="commission" id="commission" step="0.01"
                                               @if(isset($service)) value="{{$service->doctor_commission}}"@endif>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($service) ? 'Update' : 'Submit'}}"
