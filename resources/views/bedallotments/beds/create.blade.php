        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($bed) ? 'Edit Bed Info' : 'Add Bed'}}</h3>
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($bed) ? 'Edit Bed Info' : 'Add Bed'}}
                                </h3>
                            </div>
                        </div>
                        ...
                        <form class="kt-form kt-form--label-right"
                              action="{{isset($bed) ? route('beds.update',$bed->id) : route('beds.store')}}"
                              method="POST"
                                ...
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            You Can Add New Bed From This Form.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                                        ...
                                        @if(isset($departments))
                                            <select class="form-control" name="department" id="department">
                                                ...
                                                @foreach($departments as $department)
                                                    <option
                                                        value="{{$department->id}}" @if(isset($bed)) {{$department->id == $bed->department_id ? 'selected' : ''}} @endif>{{$department->name}}</option>
                                                @endforeach
                                            </select>
                                        @endif
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="notes" id="notes" cols="30"
                                                  rows="5">{{isset($bed) ? $bed->notes : ''}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($bed) ? 'Update' : 'Submit'}}"
