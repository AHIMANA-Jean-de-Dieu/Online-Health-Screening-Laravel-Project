        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($dayoffschedule) ? 'Edit Day off Schedule Info' : 'Add Day off Schedule'}}</h3>
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($dayoffschedule) ? 'Edit Day off Schedule Info' : 'Add Day off Schedule'}}
                                </h3>
                            </div>
                        </div>
                        ...
                        <form class="kt-form kt-form--label-right"
                              action="{{isset($dayoffschedule) ? route('dayoffschedules.update',$dayoffschedule->id) : route('dayoffschedules.store')}}"
                              method="POST"
                                ...
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            You Can Add New Day off Schedule From This Form.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($dayoffschedule) ? 'Update' : 'Submit'}}"
