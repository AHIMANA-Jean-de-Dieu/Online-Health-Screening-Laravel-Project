        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">Laboratorists List</h3>
                            ...
                            <tr>
                                <td>
                                    @if(strpos($laboratorist->picture,'users_pictures')!==false)
                                        <img src="{{asset('storage/'.$laboratorist->picture)}}" width="50px"
                                             height="50px">
                                    @else
                                        <img src="{{$laboratorist->picture}}" width="50px" height="50px">
                                    @endif
                                </td>
                                ...
                                <td>
                                    <form action="{{route('laboratorists.destroy',$laboratorist->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
