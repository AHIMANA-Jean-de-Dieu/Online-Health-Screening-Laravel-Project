        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($laboratorist) ? 'Edit Laboratorist Info' : 'Add Laboratorist'}}</h3>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($laboratorist) ? 'Edit Laboratorist Info' : 'Add Laboratorist'}}
                                </h3>
                            </div>
                        </div>
                        <!--begin::Form-->
                        <form style="background-color:CadetBlue" class="kt-form kt-form--label-right"
                                ...
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            You Can Add New Laboratorist From This Form.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
                                            <div class="kt-avatar__holder" @if(isset($laboratorist)) @if(strpos($laboratorist->picture,'users_pictures')!==false) style="background-image: url({{asset('storage/'.$laboratorist->picture)}})" @else style="background-image: url({{$laboratorist->picture}})" @endif  @else style="background-image: url(&quot;http://keenthemes.com/metronic/preview/default/custom/user/assets/media/users/300_20.jpg&quot;);" @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="address" id="address" cols="30"
                                                  rows="5">{{isset($laboratorist) ? $laboratorist->address : ''}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="gender" id="gender">
                                            ...
                                            <option
                                                value="male" @if(isset($laboratorist)) {{$laboratorist->gender == 'male' ? 'selected' : ''}} @endif>
                                                male
                                            </option>
                                            <option
                                                value="female" @if(isset($laboratorist)) {{$laboratorist->gender == 'female' ? 'selected' : ''}} @endif>
                                                female
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="kt_select2_3" class="kt-select2 form-control" name="departments[]" id="departments" multiple>
                                            @foreach($departments as $department)
                                                <option value="{{$department->id}}" @if(isset($laboratorist)) {{$laboratorist->hasDepartment($department->id) ? 'selected' : ''}} @endif>
                                                    {{$department->name}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($laboratorist) ? 'Update' : 'Submit'}}"
