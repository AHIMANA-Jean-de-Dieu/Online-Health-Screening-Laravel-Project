        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">Receptionists List</h3>
                ...
                <div class="kt-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable kt_table_1">
                        ...
                        @foreach($receptionists as $receptionist)
                            <tr>
                                <td>
                                    @if(strpos($receptionist->picture,'users_pictures')!==false)
                                        <img src="{{asset('storage/'.$receptionist->picture)}}" width="50px"
                                             height="50px">
                                    @else
                                        <img src="{{$receptionist->picture}}" width="50px" height="50px">
                                    @endif
                                </td>
