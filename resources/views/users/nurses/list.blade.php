        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">Nurses List</h3>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{route('nurses.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <div class="kt-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable kt_table_1">
                        ...
                        @foreach($nurses as $nurse)
                            <tr>
                                <td>
                                    @if(strpos($nurse->picture,'users_pictures')!==false)
                                        <img src="{{asset('storage/'.$nurse->picture)}}" width="50px"
                                             height="50px">
                                    @else
                                        <img src="{{$nurse->picture}}" width="50px" height="50px">
                                    @endif
                                </td>
                                ...
                                <td>{{$nurse->mobile}}</td>
                                <td>
                                    @foreach($nurse->departments as $de)
                                        <span
