        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($accountant) ? 'Edit Accountant Info' : 'Add Accountant'}}</h3>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($accountant) ? 'Edit Accountant Info' : 'Add Accountant'}}
                                </h3>
                            </div>
                        </div>
                        <!--begin::Form-->
                        <form style="background-color:CadetBlue" class="kt-form kt-form--label-right"
                                ...
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        ...
                                        <div class="alert-text">
                                            You Can Add New Accountant From This Form.
                                        </div>
                                    </div>
                                </div>
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
                                            <div class="kt-avatar__holder" @if(isset($accountant)) @if(strpos($accountant->picture,'users_pictures')!==false) style="background-image: url({{asset('storage/'.$accountant->picture)}})" @else style="background-image: url({{$accountant->picture}})" @endif  @else style="background-image: url(&quot;http://keenthemes.com/metronic/preview/default/custom/user/assets/media/users/300_20.jpg&quot;);" @endif>

                                            </div>
                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change a photo">
                                                <i class="fa fa-pen"></i>
                                                <input type="file" name="picture" accept=".png, .jpg, .jpeg">
                                            </label>
                                            <span class="kt-avatar__cancel" data-toggle="kt-tooltip" title="" data-original-title="Cancel a photo">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="address" id="address" cols="30"
                                                  rows="5">{{isset($accountant) ? $accountant->address : ''}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    ...
                                    <div class="input-group date">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                                            <input type="text" class="form-control" readonly="" name="birth_date" id="date"
                                               value="{{isset($accountant) ? $accountant->birth_date : ''}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="gender" id="gender">
                                            ...
                                            <option
                                                value="male" @if(isset($accountant)) {{$accountant->gender == 'male' ? 'selected' : ''}} @endif>
                                                male
                                            </option>
                                            <option
                                                value="female" @if(isset($accountant)) {{$accountant->gender == 'female' ? 'selected' : ''}} @endif>
                                                female
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="phone" class="form-control" type="number" name="phone"
                                               value="{{isset($accountant) ? $accountant->phone : ''}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="mobile" class="form-control" type="number" name="mobile"
                                               value="{{isset($accountant) ? $accountant->mobile : ''}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="emergency" class="form-control" type="number" name="emergency"
                                               value="{{isset($accountant) ? $accountant->emergency : ''}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="kt_select2_3" class="kt-select2 form-control" name="departments[]" id="departments" multiple>
                                            @foreach($departments as $department)
                                                <option value="{{$department->id}}" @if(isset($accountant)) {{$accountant->hasDepartment($department->id) ? 'selected' : ''}} @endif>
                                                    {{$department->name}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($accountant) ? 'Update' : 'Submit'}}"
